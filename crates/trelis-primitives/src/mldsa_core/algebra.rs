...
use super::module_lattice::algebra;

/// The base field for ML-DSA: Z_q where q = 8380417 (the ML-DSA prime).
...
mod test {
    ...
    use crate::mldsa_core::MlDsa65;
    use crate::mldsa_core::param::ParameterSet;
